...
|6. Hypothesis Testing I | <ul><li>general framework of testing</li> <li>p-values and error probabilities</li> <li>common parametric tests</li></ul> | <ul><li>wk6_data_visualization.pdf</li></ul> | <ul><li>wk6demo.zip</li></ul> | <ul><li>Quiz 5 due</li></ul> |
|7. Hypothesis Testing II | <ul><li>likelihood ratio test</li> <li>goodness of fit test</li> <li>permutation test</li> <li>multiple testing and FDR control</li></ul> |  <ul><li>wk7_exploratory_data_analysis.pdf</li></ul> | <ul><li>wk7demo.zip</li></ul> | <ul><li>HW3.zip due</li></ul> |
|8. Midterm Exam| <ul><li> midterm review and buff time </li></ul> |  |  |  | <ul><li>HW4.zip assigned </li></ul> |
|9. Bayesian Inference | <ul><li> the Bayesian method</li> <li> conjugate families and non-informative priors</li> <li>posterior inference</li> <li>empirical Bayes</li></ul> | <ul><li>wk9_prob_and_stats.pdf</li></ul> | <ul><li>wk9demo.zip</li></ul> | <ul><li>Quiz 6 due</li></ul> |
|10. Stochastic Processes | <ul><li> Markov Chains</li> <li>Poisson Processes</li></ul> | <ul><li>wk10_hypothesis_testing.pdf</li></ul> | <ul><li>wk10demo.zip</li></ul> | <ul><li>HW4.zip due</li> <li>Quiz 7 due</li> <li>HW5.zip assigned</li></ul> |
|11. Linear Regression | <ul><li>correlation and simple linear regression</li> <li>least square and maximum likelihood</li> <li>multiple linear regression</li> <li>model comparison and selection</li></ul>| <ul><li>wk11_correlation_regression.pdf</li></ul> | <ul><li>wk11demo.zip</li></ul> | <ul><li>Quiz 8 due</li></ul>  |
